...
from app.models.orm import attendance as orm_attendance
...
class AttendanceRepository:
    def get_attendance(self, db: Session, attendance_id: int) -> Optional[orm_attendance.Attendance]:
        return db.query(orm_attendance.Attendance).filter(orm_attendance.Attendance.id == attendance_id).first()
