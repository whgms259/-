...
def get_attendance(db: Session, attendance_id: int) -> Optional[orm_attendance]:
    return attendance_repository.get_attendance(db=db, attendance_id=attendance_id)

def get_attendances_by_user(db: Session, user_id: int) -> List[orm_attendance]:
    return attendance_repository.get_attendances_by_user(db=db, user_id=user_id)

def create_attendance(db: Session, attendance: pydantic_attendance.AttendanceCreate, user_id: int) -> orm_attendance:
